...
export default function ChapterMakerPage() {
  ...
  function openPlaytest() {
    saveMakerDraft(draft);
    router.push("/admin/editor/maker/playtest");
  }
  ...
  return (
    <main className="maker-app">
      <header className="maker-topbar">
        <Link className="maker-brand" href="/admin/editor/maker/identity"><Image src="/campusdrop_logo.png" alt="Campus Drop" width={36} height={36} priority unoptimized /><span>Maker</span></Link>
        <nav className="maker-step-nav" aria-label="Maker 단계"><Link href="/admin/editor/maker/identity">1. Game identity</Link><strong>2. Chapters</strong><span>3. Playtest</span></nav>
